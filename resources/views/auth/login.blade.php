...
<div class="w-full max-w-md">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Connect with the world</p>
    </div>

    <!-- Card -->
    <x-liquid-glass-card class="p-8">
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mb-6">Welcome back</h2>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div>
                <div class="flex justify-between items-center mb-1">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-xs text-green-600 dark:text-green-400 hover:underline">
                            Forgot password?
                        </a>
                    @endif
                </div>
            ...
            <div class="flex items-center">
                <input id="remember_me" type="checkbox" name="remember"
                       class="w-4 h-4 text-green-600 border-gray-300 dark:border-gray-600 rounded">
        ...
        <p class="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
            ...
            <a href="{{ route('register') }}" class="text-green-600 dark:text-green-400 font-medium hover:underline">Sign up</a>
        </p>
    </x-liquid-glass-card>
</div>
